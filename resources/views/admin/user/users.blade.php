...
<div>
  ...
  <div>
    <button class="float-end btn btn-success"> <a href="{{ route('admin.user.create') }}" class="text-decoration-none text-light"> Create a User <i class="bi bi-person-fill-add"></i> </a></button>
  </div>
